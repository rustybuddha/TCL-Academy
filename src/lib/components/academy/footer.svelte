    ...
    <footer class="md:hidden block w-full bg-[#FFFFFF] pt-[64px] text-[#33444F] px-[32px] pb-[80px]">
        <div class="space-y-[32px]">
          ...
          <div class="">
            ...
            <div class="grid grid-cols-3 gap-y-1 text-[14px] font-[300]">
              <!-- <div> -->
                ...
                <a href="/career-paths" class="block text-[#33444F] hover:text-[#33444F] mb-2">Curriculum</a>
                <a href="/academy#VideoTestimonials" class="block text-[#33444F] hover:text-[#33444F] mb-2">Testimonials</a>
          ...
          <div class="">
            ...
            <button 
              class="font-rubik w-full bg-[#093baa] text-[#FFFFFF] py-3 rounded-lg border border-[#111] hover:bg-[#1f3569] shadow-[3px_6px_0px_#000000] transition-all ease-in duration-500"
              on:click={()=>{redirectTo('/academy/registration')}}
            >
              Register Now
            </button>
