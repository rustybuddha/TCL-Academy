<!-- Testimonials Section  -->
 <script>
  import StudentTest from "./StudentTest.svelte";
 </script>
<div class="hidden lg:block w-full" style="background-image: url('/academy/testimonial-desktop-full.svg'); background-size: cover; background-position: center;">
  <StudentTest/>
</div>
...
<div class="lg:hidden mx-auto flex flex-col pb-12 relative"
  ...
  <div class="mx-auto bg-white rounded-md p-6 border border-gray-200 shadow-md mb-2">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-1.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-1.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
      <div class="flex pt-2">
        <div class="pr-3"><a href="/"><img src="/academy/testimonials-mobile-3.svg" alt=""></a></div>
        <div><a href="/"><img src="/academy/testimonials-mobile-4.svg" alt=""></a></div>
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto mt-5 bg-white rounded-md p-6 border border-gray-200 shadow-md my-2">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-2.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-2.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
  ...
  <div class="mx-auto mt-5 bg-white rounded-md p-6 border border-gray-200 shadow-md my-2">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-3.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-3.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
  ...
  <div class="mx-auto mt-5 bg-white rounded-md p-6 border border-gray-200 shadow-md my-2">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-4.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-4.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
  ...
  <div class="mx-auto mt-5 bg-white rounded-md p-6 border border-gray-200 shadow-md my-2">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-5.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-5.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
  ...
  <div class="mx-auto mt-5 bg-white rounded-md p-6 border border-gray-200 shadow-md ">
    ...
    <div class="flex justify-between">
      <div class="flex pt-1 pr-3">
        <div class="pr-2"><img class=" rounded-3xl" src="/academy/testimonial-profile-6.svg" alt=""></div>
        <div><img src="/academy/testimonial-profile-mobile-name-6.svg" alt="">
          <!-- <div class="align-top text-nowrap">Amisha Akhtar Mulani</div>
          <div class=" text-gray-400">Participant, TSoC 2024</div> -->
        </div>
      </div>
